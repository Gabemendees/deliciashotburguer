    ...
    <header className="sticky top-0 z-50 w-full border-b bg-[#2B1710] shadow-md">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-6">
          ...
          <Link to="/#menu" className="text-xs font-bold text-[#F3E2CC] uppercase tracking-widest hover:text-[#E87524] transition-colors">Cardápio</Link>
          <Link to="/#menu" className="text-xs font-bold text-[#F3E2CC] uppercase tracking-widest hover:text-[#E87524] transition-colors">Hot Dogs</Link>
          <Link to="/#menu" className="text-xs font-bold text-[#F3E2CC] uppercase tracking-widest hover:text-[#E87524] transition-colors">Hambúrgueres</Link>
          <Link to="/#menu" className="text-xs font-bold text-[#F3E2CC] uppercase tracking-widest hover:text-[#E87524] transition-colors">Bebidas</Link>
        </nav>
